                ...
                <?php for ($i = 1; $i <= $day_count; $i++): ?>
                    ...
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-default h-auto py-0" data-toggle="modal"
                                data-target="#inputModal" data-day="<?= $yyyymm . '-' . sprintf('%02d', $i) ?>"><svg
                    ...
                    <div class="modal-body">
                        <div class="container">
                            ...
                            <div class="form-group pt-3">
                                <textarea
                                    class="form-control <?php if (isset($err['modal_comment']))
                                        echo 'is-invalid'; ?>"
                                    rows="5" placeholder="業務内容" id="modal_comment"
                                    name="modal_comment"><?= $modal_comment ?></textarea>
                                <div class="invalid-feedback">
                                    <?= $err['modal_comment'] ?>
                                </div>
                            </div>
